...
from data_utils import load_dialog_task, vectorize_data, load_candidates, vectorize_candidates, tokenize, \
    load_type_dict, create_candidates_mask
...
class chatBot(object):
    ...
    def train(self):
        ...
        for t in range(1, self.epochs + 1):
            ...
            for start, end in batches:
                ...
                entity_dict = create_candidates_mask(self.candidates_vec, self.word_idx, self.sentence_size,
                                                     entity_dict)
    ...
    def batch_predict(self, S, Q, n, all_entity_dict):
        ...
        for start in range(0, n, self.batch_size):
            ...
            entity_dict = create_candidates_mask(self.candidates_vec, self.word_idx, self.sentence_size, entity_dict)
